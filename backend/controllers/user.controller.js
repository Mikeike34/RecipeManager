...
export const userLogin = async (req, res) => {
    ...
    const isPasswordValid = await bcrypt.compare(password, user.password); //compares the password inputted withe the password attached to the username found in the database.
